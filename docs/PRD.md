...
2. **Переписка с клиентом по почте.** С 2026-09-25 (решение владельца) **письма не привязываются к заказам — переписка принадлежит клиенту.** В карточке заказа — последние 10 писем переписки с клиентом заказа (и форма письма с шаблонами); в карточке клиента — вся переписка. Переписка клиента — письма, где он указан, и письма с его адреса или на его адрес. Клиент входящего определяется по цепочке, номеру заказа на сайте в теме (клиент этого заказа) или адресу; не определился — письмо во вкладке «Почта → Без клиента», где его привязывают к клиенту поиском. В живом ящике — «Добавить в переписку». Пункты ниже, где говорится о привязке к заказу, заменены этим.
