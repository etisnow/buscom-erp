...
> Снимок от 2026-09-23. Живая версия (обсуждение, комментарии): https://claude.ai/code/artifact/527cb091-ee7c-4b47-8fda-47c04c893e89
...
- [x] На чём сделан bus-com.ru — **OpenCart** (закрыто 2026-09-23 по письму-уведомлению о заказе). Есть ли доступ к админке / коду — пока не выяснено.
