 ...
 */
import { z } from "zod";
import type { CustomerRequisites } from "./requisites";
...
/**
 * ИНН для сопоставления клиентов: без пробелов и дефисов, 10 или 12 цифр;
 * иначе null. Контрольную сумму не проверяет — в базе встречаются ИНН из
 * прежней ERP с опечатками, и по ним тоже надо находить клиента.
 */
