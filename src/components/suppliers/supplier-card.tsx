 ...
 * поставщика в заказе свой трек по этой цепочке; в «Отправку» заказ уходит,
    ...
    <section className="flex flex-col gap-3 rounded-lg border p-4">
      <div>
        ...
        <p className="text-muted-foreground text-sm">
          Этапы работы с поставщиком по порядку. В заказе это подстатусы «в работе»: заказ уйдёт в «Отправку», только
